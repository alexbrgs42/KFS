...
/// @brief Text mode memory takes 2 bytes for every "character" on screen. One is the ASCII code byte,
//			the other is the attribute byte (it carries the foreground color in its lowest 4 bits
